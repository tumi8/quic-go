...
import (
	...
	"github.com/tumi8/quic-go/noninternal/logutils"
...
var newConnection = func(
	...
	params := &wire.TransportParameters{
		...
		// See https://github.com/tumi8/quic-go/pull/3806.
...
func (s *connection) ConnectionState() ConnectionState {
	...
	s.connState.Info = cs.ConnectionInfo
...
func (s *connection) GetConnection() *connection {
	return s
}
