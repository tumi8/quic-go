...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/tumi8/quic-go)](https://pkg.go.dev/github.com/tumi8/quic-go)
...
Since the standard library didn't provide any QUIC APIs before the Go 1.21 release, we had to fork crypto/tls to add the required APIs ourselves: [qtls for Go 1.20](https://github.com/tumi8/qtls-go1-20).
