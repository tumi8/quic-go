...
//
//	mockgen -typed -build_flags=-tags=gomock -package mocks -destination short_header_sealer.go github.com/tumi8/quic-go/noninternal/handshake ShortHeaderSealer
//
