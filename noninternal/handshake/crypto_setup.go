...
func (h *cryptoSetup) ConnectionState() ConnectionState {
	...
	tmp := h.conn.ConnectionState()
	tmp_state := tls.ConnectionState{
		Version: tmp.Version,
		HandshakeComplete: tmp.HandshakeComplete,
		DidResume: tmp.DidResume,
		CipherSuite: tmp.CipherSuite,
		NegotiatedProtocol: tmp.NegotiatedProtocol,
		NegotiatedProtocolIsMutual: tmp.NegotiatedProtocolIsMutual,
		ServerName: tmp.ServerName,
		PeerCertificates: tmp.PeerCertificates,
		VerifiedChains: tmp.VerifiedChains,
		SignedCertificateTimestamps: tmp.SignedCertificateTimestamps,
		OCSPResponse: tmp.OCSPResponse,
