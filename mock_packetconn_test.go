...
//
//	mockgen -typed -package quic -self_package github.com/tumi8/quic-go -self_package github.com/tumi8/quic-go -destination mock_packetconn_test.go net PacketConn
//
